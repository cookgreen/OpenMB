...
namespace AMOFGameEngine.Game.Objects
{
    ...
    public class CharacterInfo : GameObjectInfo
    {
        ...
        private bool alive;
        private AnimationState as1;
        private AnimationState as2;
	    ...
	    "SliceVertical", "SliceHorizontal", "Dance", "JumpStart", "JumpLoop", "JumpEnd"};
            ...
            as1 = mesh.GetAnimationState("IdleBase");
            as2 = mesh.GetAnimationState("IdleTop");
            as1.Loop = true;
            as2.Loop = true;
            as1.Enabled = true;
            as2.Enabled = true;
        ...
        public override void SetTopAnimation(string animName)
        {
            as2 = animations.Where(o => o.AnimationName == animName).FirstOrDefault();
            if (as2 != null)
            {
                as2.Enabled = true;
                as2.Loop = true;
        ...
        public override void SetBaseAnimation(string animName)
        {
            as1 = animations.Where(o => o.AnimationName == animName).FirstOrDefault();
            if (as1 != null)
            {
                as1.Enabled = true;
                as1.Loop = true;
        ...
        {
            as1.AddTime(timeSinceLastFrame);
            as2.AddTime(timeSinceLastFrame);
        }
    }
