...
namespace AMOFGameEngine.Mod.Common
{
    ...
    public class ModContext
    {
        ...
        public void SetupMod(RenderWindow win, Keyboard keyboard, Mouse mouse, FileSystemLayer fileSystemLayer,string modName)
        {
            root = Root.Singleton;
            window = win;
            mKeyboard = keyboard;
        ...
        public virtual bool FrameEnded() { return true; }
        ...
        static ModContext singleton;
        public static ModContext Singleton
        {
            get
            {
                if (singleton == null)
                    singleton = new ModContext();
                return singleton;
            }
        }
